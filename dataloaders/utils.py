...
def decode_segmap(label_mask, dataset, plot=False):
    ...
    elif dataset == 'cityscapes' or dataset == 'dada'or \
            dataset == 'cityscapesevent'or dataset == 'dadaevent' or \
            dataset == 'kittievent' or dataset == 'bdd':
        n_classes = 19
        label_colours = get_cityscapes_labels()
    elif dataset == 'apolloscapeevent':
        n_classes = 16
        label_colours = get_apolloscapeevent_labels()
    else:
...
def get_apolloscapeevent_labels():
    return np.array([
        [128, 64, 128],
        [244, 35, 232],
        [70, 70, 70],
